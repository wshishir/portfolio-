      ...
      <div className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
          <span className="relative">
            Alex Johnson
            <span className="absolute -bottom-1 left-0 w-full h-[3px] bg-primary animate-underline"></span>
          </span>
        </h1>
        <p className="text-2xl md:text-3xl text-muted-foreground font-light">Graphic Designer & Logo Specialist</p>
      </div>
      <div className="h-20">
        <p className="text-lg md:text-xl max-w-[600px] text-primary">
          {typedText}
          <span className="animate-pulse">|</span>
        </p>
      </div>
      <div className="flex flex-col sm:flex-row gap-4">
        <Button asChild className="animate-fadeIn" style={{ animationDelay: "1.5s" }}>
          <Link href="#projects">
